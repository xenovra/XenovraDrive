...
use crate::{errors::XenovraDriveResult, repositories::storage_workers::StorageWorkersRepository};
...
impl<'d> StorageWorkersScheduler<'d> {
    ...
    pub async fn get_token(&self, storage_id: Uuid) -> XenovraDriveResult<String> {
        loop {
            // attempting
